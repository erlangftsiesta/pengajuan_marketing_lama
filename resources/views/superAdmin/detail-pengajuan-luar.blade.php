                    ...
                    <div class="card-body">
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="analisa" id="analisa" class="form-control" rows="5" readonly>{{ $approvalCA->analisa ?? 'Belum ada' }}</textarea>
                            </div>
                            ...
                            <div id="approve-section" style="display: none;">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" id="nominal_pinjaman" name="nominal_pinjaman"
                                        class="form-control" value="{{ $approvalCA->nominal_pinjaman ?? '' }}"
                                        readonly>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="tenor" class="form-label">Jangka Waktu</label>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="catatan_approve" id="catatan_approve" class="form-control" cols="30" rows="10"
                                        readonly>{{ $approvalCA->catatan ?? 'Tidak ada catatan' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="catatan" id="catatan" class="form-control" cols="30" rows="10" readonly>{{ $approvalHM->catatan ?? 'Tidak ada catatan' }}</textarea>
                                @error('catatan')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>

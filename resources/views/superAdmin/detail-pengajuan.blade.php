                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group">
                                <label for="kesimpulan_ca" class="form-label">Kesimpulan Banding Credit
                                    Analyst</label>
                                <textarea name="kesimpulan_ca" id="kesimpulan_ca" class="form-control" readonly style="width: 100%; height: 150px;">{{ $keteranganCa ? Str::ucfirst($keteranganCa->kesimpulan) : 'Tidak ada kesimpulan.' }}</textarea>
                            </div>

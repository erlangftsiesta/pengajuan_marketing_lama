                        ...
                        <form id="loanForm" action="{{ route('headMarketing.approval.approval', $nasabah->id) }}"
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $kesimpulanCa = $nasabah->pengajuan->approval->where('role', 'ca')->first();
                                    @endphp
                                    <textarea name="kesimpulan_ca" id="kesimpulan_ca" class="form-control" readonly style="width: 100%; height: 150px;">{{ $kesimpulanCa ? Str::ucfirst($kesimpulanCa->kesimpulan ?? 'Tidak ada kesimpulan.') : 'Tidak ada kesimpulan.' }}</textarea>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @php
                                            $pertimbanganCa = $nasabah->pengajuan->approval
                                                ...
                                                ->where('is_banding', '1')
                                                ->first();
                                            $kesimpulanBanding = $pertimbanganCa->kesimpulan;
                                        @endphp
                                        <textarea name="pertimbanganCa" id="pertimbanganCa" class="form-control" readonly
                                            style="width: 100%; height: 150px;">{{ $pertimbanganCa ? Str::ucfirst($pertimbanganCa->keterangan) : 'Tidak ada catatan banding.' }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="kesimpulan_ca" class="form-label">Kesimpulan Banding Credit
                                            Analyst</label>
                                        <textarea name="kesimpulan_ca" id="kesimpulan_ca" class="form-control" readonly style="width: 100%; height: 150px;">{{ $kesimpulanBanding ? Str::ucfirst($kesimpulanBanding) : 'Tidak ada kesimpulan.' }}</textarea>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="text-end">
                                        <a href="{{ route('headMarketing.riwayat') }}"

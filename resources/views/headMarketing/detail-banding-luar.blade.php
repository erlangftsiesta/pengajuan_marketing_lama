                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-step">
                            ...
                            <!-- Input Analisa -->
                            <div class="form-group mb-3">
                                <label for="catatan_banding_ca">Catatan Banding Credit Analyst</label>
                                <textarea name="catatan_banding_ca" id="catatan_banding_ca" class="form-control" cols="30" rows="10">{{ $bandingCA->catatan }}</textarea>
                            </div>

                            <div class="form-group mb-3">
                                <label for="catatan_banding_ca">Analisa Banding Credit Analyst</label>
                                <textarea name="catatan_banding_ca" id="catatan_banding_ca" class="form-control" cols="30" rows="10">{{ $bandingCA->analisa }}</textarea>
                            </div>

                            <form action="{{ route('headMarketing.approval.banding-luar', $pengajuan->id) }}"
                                method="POST">
                                @csrf

                                <!-- Input Catatan -->
                                <div class="form-group mb-3">
                                    <label for="catatan">Catatan Banding Head Marketing</label>

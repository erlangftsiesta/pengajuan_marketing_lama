                    ...
                    <div class="card-body">
                                ...
                                <div class="form-check">
                                    <label for="survey_yes" class="form-check-label">
                                        <input type="radio" id="survey_yes" name="is_survey" value="1"
                                            class="form-check-input" {{ $isSurvey ? 'checked' : '' }}>
                                        Ya
                                    </label>
                                </div>
                                <div class="form-check">
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="catatan" id="catatan" class="form-control" cols="30" rows="10" readonly>{{ $approvalHM->catatan }}</textarea>
                                @error('catatan')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            @if ($pengajuan->is_banding == 1)
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <label for="status">Status : <span
                                            ...
                                            {{ Str::title($approvalBandingCA->status) }} </span></label>

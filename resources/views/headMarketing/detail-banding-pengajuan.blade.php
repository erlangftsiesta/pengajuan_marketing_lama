        ...
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="loanForm" action="{{ route('headMarketing.approval.approval-banding', $nasabah->id) }}"
                            method="POST">
                            @csrf
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alasan_banding" id="alasan_banding" class="form-control" readonly
                                        style="width: 100%; height: 150px;">{{ $nasabah->pengajuan->alasan_banding ?? 'Tidak ada catatan.' }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="kesimpulan_ca" class="form-label">Kesimpulan Credit Analyst</label>
                                    @php
                                        $kesimpulanBandingCA = $nasabah->pengajuan->approval
                                            ->where('role', 'ca')
                                            ->where('is_banding', '1')
                                            ->first();
                                    @endphp
                                    <textarea name="kesimpulan_ca" id="kesimpulan_ca" class="form-control" readonly style="width: 100%; height: 150px;">{{ $kesimpulanBandingCA ? Str::ucfirst($kesimpulanBandingCA->kesimpulan) : 'Tidak ada kesimpulan.' }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="keterangan" class="form-label">Pertimbangan Banding Head Marketing</label>
                                    <textarea name="keterangan" id="keterangan" class="form-control" required style="width: 100%; height: 150px;"></textarea>
                                </div>

                                <div class="d-flex justify-content-between">
                                    <div class="text-first">
                                        <a href="{{ route('headMarketing.approval') }}"
                                            class="btn btn-secondary rounded">Kembali</a>
                                    </div>
                                    <div class="text-end">
                                        <button type="submit" name="action" value="approve"
                                            class="btn btn-gradient-success rounded">Approve Banding</button>
                                        <button type="submit" name="action" value="reject"
                                            class="btn btn-gradient-danger rounded">Reject Banding</button>
                                    </div>
                                </div>
                            </div>
                        </form>

        ...
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="loanForm" action="{{ route('creditAnalyst.approval.approval-banding', $nasabah->id) }}"
                            method="POST">
                            @csrf
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    <label for="keterangan" class="form-label">Pertimbangan Banding Credit Analyst</label>
                                    <textarea name="keterangan" id="keterangan" class="form-control" required style="width: 100%; height: 150px;"></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="kesimpulan" class="form-label">Kesimpulan Banding Credit Analyst</label>
                                    <textarea name="kesimpulan" id="kesimpulan" class="form-control" required style="width: 100%; height: 150px;"></textarea>
                                </div>

                                <div class="d-flex justify-content-between">
                                    <div class="text-first">
                                        <a href="{{ route('creditAnalyst.approval') }}"

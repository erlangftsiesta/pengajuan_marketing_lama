        ...
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="loanForm" action="{{ route('creditAnalyst.approval.approval', $nasabah->id) }}"
                            method="POST">
                            @csrf
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    @endphp
                                    <textarea name="keterangan_ca" id="keterangan_ca" class="form-control" readonly style="width: 100%; height: 150px;">{{ Str::ucfirst($keteranganCa->keterangan) ?? 'Tidak ada catatan.' }}</textarea>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="text-end">
                                        <a href="{{ route('creditAnalyst.riwayat') }}"

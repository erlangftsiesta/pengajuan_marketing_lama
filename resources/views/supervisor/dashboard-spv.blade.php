            ...
            <div class="card bg-gradient-primary card-img-holder text-white">
                <div class="card-body">
                    <img src="{{ asset('assets/images/dashboard/circle.svg') }}" class="card-img-absolute"
                        alt="circle-image" />
                    <h1 class="text-white">Dashboard Supervisor</h1>
                </div>
            </div>
        </div>
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-info card-img-holder text-white">
                <div class="card-body">
                    ...
                    <a href="{{ route('supervisor.approval') }}" class="text-white text-decoration-none">
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-success card-img-holder text-white">
                <div class="card-body">
                    ...
                    <a href="{{ route('supervisor.riwayat') }}" class="text-white text-decoration-none">
                        <h2 class="mb-5">{{ $approvedCount }} Pengajuan</h2>
                    </a>
                    <a href="{{ route('supervisor.riwayat') }}" class="text-white text-decoration-none">
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-danger card-img-holder text-white">
                <div class="card-body">
                    ...
                    <a href="{{ route('supervisor.riwayat') }}" class="text-white text-decoration-none">
                        <h2 class="mb-5">{{ $rejectedCount }} pengajuan</h2>
                    </a>
                    <a href="{{ route('supervisor.riwayat') }}" class="text-white text-decoration-none">

...
@section('content')
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a href="{{ route('creditAnalystLuar.pengajuan') }}" class="btn btn-success btn-sm">Back</a>
                        <h4 class="card-title text-center mt-2 mb-2">Form Detail Pengajuan Pinjaman</h4>
                        <div style="width: 80px;"></div>
                    </div>
                    <div class="card-body">
                        <form id="loanForm" action="{{ route('creditAnalystLuar.verifikasi', $pengajuan->id) }}"
                            ...
                            <div class="form-step form-step-active">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $pengajuan->nasabahLuar->foto_ktp) }}?v={{ time() }}"
                                            target="_blank">
                                            <img src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $pengajuan->nasabahLuar->foto_ktp) }}?v={{ time() }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $pengajuan->nasabahLuar->foto_kk) }}?v={{ time() }}"
                                            target="_blank">
                                            <img src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $pengajuan->nasabahLuar->foto_kk) }}?v={{ time() }}"
                                                alt="Foto KTP" class="img-thumbnail"
                                                style="max-width: 100%; height: auto;">
                                        </a>
                                    </div>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <embed
                                                                src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $pengajuan->nasabahLuar->dokumen_pendukung ?? '') }}?v={{ time() }}"
                                ...
                                <div class="form-group row mb-0">
                                    <label class="col-sm-3 col-form-label">Validasi Nasabah</label>
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="validasi_nasabah"
                                                    value="1"
                                                    {{ $pengajuan->nasabahLuar->validasi_nasabah ? 'checked' : '' }}
                                                    onchange="toggleCatatan(this, 'catatan-nasabah')">
                                                Clear
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mt-0" id="catatan-nasabah"
                                    style="display: {{ $pengajuan->nasabahLuar->validasi_nasabah ? 'none' : 'block' }}">
                                    <label for="catatan_nasabah" class="form-label">Catatan</label>
                                    <textarea name="catatan_nasabah" id="catatan_nasabah" class="form-control" cols="30" rows="10">{{ $pengajuan->nasabahLuar->catatan ?? '' }}</textarea>
                                </div>
                                <div class="text-end">
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Validasi Alamat</label>
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="validasi_alamat"
                                                    value="1"
                                                    {{ $pengajuan->nasabahLuar->alamatLuar->validasi_alamat ? 'checked' : '' }}
                                                    onchange="toggleCatatan(this, 'catatan-alamat')">
                                                Clear
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mt-0" id="catatan-alamat"
                                    style="display: {{ $pengajuan->nasabahLuar->alamatLuar->validasi_alamat ? 'none' : 'block' }}">
                                    <label for="catatan_alamat" class="form-label">Catatan</label>
                                    <textarea name="catatan_alamat" id="catatan_alamat" class="form-control" cols="30" rows="10">{{ $pengajuan->nasabahLuar->alamatLuar->catatan ?? '' }}</textarea>
                                </div>
                                <div class="text-end">
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Validasi Pekerjaan</label>
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="validasi_pekerjaan"
                                                    value="1"
                                                    {{ $pengajuan->nasabahLuar->pekerjaanLuar->validasi_pekerjaan ? 'checked' : '' }}
                                                    onchange="toggleCatatan(this, 'catatan-pekerjaan')">
                                                Clear
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mt-0" id="catatan-pekerjaan"
                                    style="display: {{ $pengajuan->nasabahLuar->pekerjaanLuar->validasi_pekerjaan ? 'none' : 'block' }}">
                                    <label for="catatan_pekerjaan" class="form-label">Catatan</label>
                                    <textarea name="catatan_pekerjaan" id="catatan_pekerjaan" class="form-control" cols="30" rows="10">{{ $pengajuan->nasabahLuar->pekerjaanLuar->catatan ?? '' }}</textarea>
                                </div>
                                <div class="text-end">
                                    <button type="button" class="btn btn-secondary prev-btn">Previous</button>
                                    <button type="submit" class="btn btn-primary next-btn">Next</button>
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Validasi Penjamin</label>
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="validasi_penjamin"
                                                    value="1"
                                                    {{ $pengajuan->nasabahLuar->penjaminLuar->validasi_penjamin ? 'checked' : '' }}
                                                    onchange="toggleCatatan(this, 'catatan-penjamin')">
                                                Clear
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mt-0" id="catatan-penjamin"
                                    style="display: {{ $pengajuan->nasabahLuar->penjaminLuar->validasi_penjamin ? 'none' : 'block' }}">
                                    <label for="catatan_penjamin" class="form-label">Catatan</label>
                                    <textarea name="catatan_penjamin" id="catatan_penjamin" class="form-control" cols="30" rows="10">{{ $pengajuan->nasabahLuar->penjaminLuar->catatan ?? '' }}</textarea>
                                </div>
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Validasi Tanggungan dan Pinjaman Lain</label>
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="validasi_tanggungan"
                                                    value="1"
                                                    {{ $pengajuan->nasabahLuar->tanggunganLuar->validasi_tanggungan ? 'checked' : '' }}
                                                    onchange="toggleCatatan(this, 'catatan-tanggungan')">
                                                Clear
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mt-0" id="catatan-tanggungan"
                                    style="display: {{ $pengajuan->nasabahLuar->tanggunganLuar->validasi_tanggungan ? 'none' : 'block' }}">
                                    <label for="catatan_tanggungan" class="form-label">Catatan</label>
                                    <textarea name="catatan_tanggungan" id="catatan_tanggungan" class="form-control" cols="30" rows="10">{{ $pengajuan->nasabahLuar->tanggunganLuar->catatan ?? '' }}</textarea>
                                </div>
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Validasi Kontak Darurat</label>
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input"
                                                    name="validasi_kontak_darurat" value="1"
                                                    {{ $pengajuan->nasabahLuar->kontakDarurat->validasi_kontak_darurat ? 'checked' : '' }}
                                                    onchange="toggleCatatan(this, 'catatan-kontak-darurat')">
                                                Clear
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input"
                                                    name="validasi_kontak_darurat" value="0"
                                                    {{ !$pengajuan->nasabahLuar->kontakDarurat->validasi_kontak_darurat ? 'checked' : '' }}
                                                    onchange="toggleCatatan(this, 'catatan-kontak-darurat')">
                                                Revisi
                                            </label>
                                ...
                                <div class="form-group mt-0" id="catatan-kontak-darurat"
                                    style="display: {{ $pengajuan->nasabahLuar->kontakDarurat->validasi_kontak_darurat ? 'none' : 'block' }}">
                                    ...
                                    <textarea name="catatan_kontak_darurat" id="catatan_kontak_darurat" class="form-control" cols="30"
                                        rows="10">{{ $pengajuan->nasabahLuar->kontakDarurat->catatan ?? '' }}</textarea>
                                </div>
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="nominal_pinjaman" name="nominal_pinjaman"
                                        class="form-control" value="{{ $pengajuan->nominal_pinjaman }}" readonly>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="modal fade" id="modalBerkasJaminan" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <embed
                                                            src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $pengajuan->berkas_jaminan) }}?t={{ time() }}"
                                                            type="application/pdf" width="100%" height="500px">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Validasi Pengajuan</label>
                                    @php
                                        $validasiPengajuan = optional($pengajuan)->validasi_pengajuan;
                                    @endphp
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="validasi_pengajuan"
                                                    value="1" {{ $validasiPengajuan ? 'checked' : '' }}
                                                    onchange="toggleCatatan(this, 'catatan-pengajuan')">
                                                Clear
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="validasi_pengajuan"
                                                    value="0" {{ !$validasiPengajuan ? 'checked' : '' }}
                                                    onchange="toggleCatatan(this, 'catatan-pengajuan')">
                                                Revisi
                                            </label>
                                        </div>
                                ...
                                <div class="form-group mt-0" id="catatan-pengajuan"
                                    style="display: {{ $validasiPengajuan ? 'none' : 'block' }}">
                                    <label for="catatan_pengajuan" class="form-label">Catatan</label>
                                    <textarea name="catatan_pengajuan" id="catatan_pengajuan" class="form-control" cols="30" rows="10">{{ $pengajuan->catatan ?? '' }}</textarea>
                                </div>
    ...
    <script>
        ...
        // function toggleCatatanNasabah(element) {
        //     const catatanNasabah = document.getElementById('catatan-nasabah');
        //     const catatanAlamat = document.getElementById('catatan-alamat');
        //     const catatanPekerjaan = document.getElementById('catatan-pekerjaan');
        //     const catatanTanggungan = document.getElementById('catatan-tanggungan');
        //     const catatanPenjamin = document.getElementById('catatan-penjamin');
        //     const catatanKontakDarurat = document.getElementById('catatan-kontak-darurat');
        //     const catatanPengajuan = document.getElementById('catatan-pengajuan');

        //     if (element.value === "1") {
        //         // Jika "Clear" dipilih, sembunyikan catatan
        //         catatanNasabah.style.display = 'none';
        //         catatanAlamat.style.display = 'none';
        //         catatanPekerjaan.style.display = 'none';
        //         catatanTanggungan.style.display = 'none';
        //         catatanPenjamin.style.display = 'none';
        //         catatanKontakDarurat.style.display = 'none';
        //         catatanPengajuan.style.display = 'none';
        //     } else {
        //         // Jika "Revisi" dipilih, tampilkan catatan
        //         catatanNasabah.style.display = 'block';
        //         catatanAlamat.style.display = 'block';
        //         catatanPekerjaan.style.display = 'block';
        //         catatanTanggungan.style.display = 'block';
        //         catatanPenjamin.style.display = 'block';
        //         catatanKontakDarurat.style.display = 'block';
        //         catatanPengajuan.style.display = 'block';
        //     }
        // }

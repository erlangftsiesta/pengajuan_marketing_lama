            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a href="{{ route('creditAnalystLuar.riwayat') }}" class="btn btn-success btn-sm">Back</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-step form-step-active">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="validasi_nasabah"
                                                ...
                                                onchange="toggleCatatan(this, 'catatan-nasabah')" readonly>
                                            Clear
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mt-0" id="catatan-nasabah"
                                ...
                                <textarea name="catatan_nasabah" id="catatan_nasabah" class="form-control" cols="30" rows="10"></textarea>
                            </div>
                            <div class="text-end">
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group mt-0" id="catatan-alamat"
                                ...
                                <textarea name="catatan_alamat" id="catatan_alamat" class="form-control" cols="30" rows="10"></textarea>
                            </div>
                            <div class="text-end">
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group mt-0" id="catatan-pekerjaan"
                                ...
                                <textarea name="catatan_pekerjaan" id="catatan_pekerjaan" class="form-control" cols="30" rows="10"></textarea>
                            </div>
                            <div class="text-end">
                                <button type="button" class="btn btn-secondary prev-btn">Previous</button>
                                <button type="submit" class="btn btn-primary next-btn">Next</button>
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group mt-0" id="catatan-penjamin"
                                ...
                                <textarea name="catatan_penjamin" id="catatan_penjamin" class="form-control" cols="30" rows="10"></textarea>
                            </div>
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group mt-0" id="catatan-tanggungan"
                                ...
                                <textarea name="catatan_tanggungan" id="catatan_tanggungan" class="form-control" cols="30" rows="10"></textarea>
                            </div>
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="validasi_kontak_darurat"
                                                value="1"
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group mt-0" id="catatan-pengajuan"
                                ...
                                <textarea name="catatan_pengajuan" id="catatan_pengajuan" class="form-control" cols="30" rows="10"></textarea>
                            </div>
                                    ...
                                    <div class="row">
                                        @forelse ($pengajuan?->hasilSurvey?->fotoHasilSurvey ?? [] as $item)
                                            <div class="col-md-3 mb-3">
                                                <img src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/hasil_survey/' . $item->foto_survey) }}?v={{ time() }}"
                        ...
                        <div class="form-step">
                            @php
                                ...
                                $approvalHM = $pengajuan->approval->firstWhere('role', 'hm');
                            @endphp
                            <h5>Informasi Banding</h5>

                            <div class="form-group mb-3">
                                <label for="alasan_banding">Alasan Banding Marketing</label>
                                <textarea name="alasan_banding" id="alasan_banding" class="form-control" cols="30" rows="10"
                                    readonly>{{ $pengajuan->alasan_banding }}</textarea>
                            </div>

                            <h5>Informasi Approval</h5>

                            <div class="form-group mb-3">
                                <label for="catatan_ca">Catatan Credit Analyst</label>
                                <textarea name="catatan_ca" id="catatan_ca" class="form-control" cols="30" rows="10" readonly>{{ $approvalCA->catatan }}</textarea>
                            </div>

                            <div class="form-group mb-3">
                                <label for="catatan_hm">Catatan Head Marketing</label>
                                <textarea name="catatan_hm" id="catatan_hm" class="form-control" cols="30" rows="10" readonly>{{ $approvalHM->catatan }}</textarea>
                            </div>

                            <form action="{{ route('creditAnalystLuar.approval-banding', $pengajuan->id) }}"
                                method="POST">
                                @csrf
                                <h5>Approval Banding</h5>
                                <!-- Input Analisa -->
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-check">
                                        <label for="approve_yes" class="form-check-label">
                                            <input type="radio" id="approve_yes" name="is_approve" value="1"
                                                class="form-check-input" {{ old('is_approve') == '1' ? 'checked' : '' }}
                                                required>
                                            Approve
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label for="approve_no" class="form-check-label">
                                            <input type="radio" id="approve_no" name="is_approve" value="0"
                                                class="form-check-input" {{ old('is_approve') == '0' ? 'checked' : '' }}
                                                required>
                                            Reject
                                        </label>
                                    </div>

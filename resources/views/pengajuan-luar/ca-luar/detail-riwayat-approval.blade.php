                        ...
                        <div class="form-step">
                            ...
                            <div id="approve-section" style="display: none;">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="catatan_approve" id="catatan_approve" class="form-control" cols="30" rows="10"
                                        readonly>{{ $approvalCA->catatan }}</textarea>
                                </div>
                            </div>
                            ...
                            <div id="reject-section" style="display: none;">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="catatan_reject" id="catatan_reject" class="form-control" cols="30" rows="10"
                                        readonly>{{ $approvalCA->catatan }}</textarea>
                                </div>
                            </div>

                            @if ($pengajuan->is_banding == 1)
                                ...
                                @php
                                    $approvalBandingCA = $pengajuan->approval
                                        ->where('role', 'ca')
                                ...
                                <div class="form-group mb-3">
                                    <label for="catatan_bandingca">Catatan Banding</label>
                                    <br>
                                    @if ($approvalBandingCA)
                                        <label for="status">
                                            Status:
                                            <span
                                                class="badge {{ $approvalBandingCA->status == 'rejected' ? 'bg-danger' : 'bg-success' }}">
                                                {{ Str::title($approvalBandingCA->status) }}
                                            </span>
                                        </label>
                                        <textarea name="catatan_bandingca" id="catatan_bandingca" class="form-control" cols="30" rows="10"
                                            readonly>{{ $approvalBandingCA->catatan }}</textarea>
                                    @else
                                        <label for="status">
                                            Status: <span class="badge bg-secondary">Belum Ada</span>
                                        </label>
                                        <textarea name="catatan_bandingca" id="catatan_bandingca" class="form-control" cols="30" rows="10"
                                            readonly>Tidak ada catatan.</textarea>
                                    @endif
                                </div>
                            @endif

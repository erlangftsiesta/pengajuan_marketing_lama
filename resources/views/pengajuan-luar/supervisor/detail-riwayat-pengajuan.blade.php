                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group" id="clear_notes">
                                <label for="catatan">Catatan/Rekomendasi</label>
                                <textarea name="catatan" id="catatan" class="form-control" cols="30" rows="10">{{ $pengajuan->approval->firstWhere('role', 'spv')->catatan ?? '' }}</textarea>
                            </div>

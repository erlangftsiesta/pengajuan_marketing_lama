                                ...
                                @if ($pengajuan->isNotEmpty())
                                    ...
                                    @foreach ($pengajuan as $item)
                                        @php
                                            ...
                                            $approvalSPV = $item->approval->where('role', 'spv')->last();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($pengajuanDiproses > 1 && !$loop->last)
                                                    <br>
                                            ...
                                            <td>
                                                <span
                                                    class="badge {{ $approvalSPV->status == 'rejected' ? 'bg-danger' : 'bg-success' }}">
                                                    {{ Str::title($approvalSPV->status) }}
                                                </span>
                                            </td>
                                            <td>
                                                {{ $approvalSPV->created_at->translatedFormat('d F Y') }} <br>
                                                Pukul {{ $approvalSPV->created_at->translatedFormat('H:i') }} WIB
                                            </td>
                                            <td>
                                                <a href="{{ route('supervisor.detail.riwayat.pengajuan.luar', $item->id) }}"

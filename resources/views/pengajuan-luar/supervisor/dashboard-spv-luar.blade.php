        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-info card-img-holder text-white">
                <div class="card-body">
                    ...
                    <a href="{{ route('supervisor.luar') }}" class="text-white text-decoration-none">
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-success card-img-holder text-white">
                <div class="card-body">
                    ...
                    <a href="{{ route('supervisor.riwayat.pengajuan.luar') }}" class="text-white text-decoration-none">

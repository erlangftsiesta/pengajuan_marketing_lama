...
@section('content')
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a href="{{ route('supervisor.luar') }}" class="btn btn-success btn-sm">Back</a>
                        <h4 class="card-title text-center mt-2 mb-2">Form Detail Pengajuan Pinjaman</h4>
                        <div style="width: 80px;"></div>
                    </div>
                    <div class="card-body">
                        <form id="loanForm" action="{{ route('supervisor.luar.check', $pengajuan->id) }}" method="POST"
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="provinsi" name="provinsi" class="form-control"
                                        value="{{ $pengajuan->nasabahLuar->alamatLuar->provinsi ?? 'Belum diisi' }}"
                                        readonly>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    <h5>Hasil Checking SPV</h5>
                                    <select name="hasil_checking" id="hasil_checking" class="form-select" required>
                                        <option value="">Pilih</option>
                                ...
                                <div class="form-group" id="revisi_reason" style="display: none;">
                                    <label for="catatan_spv">Alasan Revisi</label>
                                    <textarea name="catatan_spv" id="catatan_spv" class="form-control" cols="30" rows="10"></textarea>
                                </div>

                                <div class="form-group" id="clear_notes" style="display: none;">
    ...
    <script>
        ...
        document.getElementById("hasil_checking").addEventListener("change", function() {
            let selectedValue = this.value;

            document.getElementById("revisi_reason").style.display = (selectedValue === "revisi") ? "block" :
                "none";
            document.getElementById("clear_notes").style.display = (selectedValue === "clear") ? "block" : "none";
        });

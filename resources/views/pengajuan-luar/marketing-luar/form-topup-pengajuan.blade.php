...
@section('breadcrumb-title', '/ Pengajuan Top Up')
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <h4 class="card-title text-center mt-2 mb-2">Form Top Up Pengajuan Pinjaman</h4>
                        <div style="width: 80px;"></div>
                    </div>
                    <div class="card-body">
                        <form id="loanForm" action="{{ route('marketingLuar.topUp.store', $nasabah->id) }}" method="POST"
                            ...
                            <div class="form-step form-step-active">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status_nikah" id="status_nikah" class="form-select">
                                        ...
                                        <option
                                            value="Belum Menikah"{{ $nasabah->status_nikah == 'Belum Menikah' ? 'selected' : '' }}>
                                            Belum Menikah</option>
                                        <option value="Menikah"
                                            {{ $nasabah->status_nikah == 'Menikah' ? 'selected' : '' }}>
                                            Menikah</option>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->foto_ktp) }}"
                                            target="_blank">
                                            <img src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->foto_ktp) }}?t={{ time() }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <br>
                                        <a href="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->foto_kk) }}"
                                            target="_blank">
                                            <img src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->foto_kk) }}?t={{ time() }}"
                                                alt="Foto KTP" class="img-thumbnail"
                                                style="max-width: 100%; height: auto;">
                                        </a>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        @if ($nasabah)
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <embed
                                                                src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->dokumen_pendukung ?? '') }}?t={{ time() }}"
                                            ...
                                            <span class="form-text">File :
                                                {{ $nasabah->dokumen_pendukung ?? '' }}</span>
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Upload Foto KTP" value="{{ $nasabah->foto_ktp }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Upload Foto Kartu Keluarga" value="{{ $nasabah->foto_kk }}">
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn btn-gradient-info py-3"
                                                type="button">Pilih File</button>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            ...
                                            value="{{ $nasabah->dokumen_pendukung }}">
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn btn-gradient-info py-3"
                                                type="button">Pilih File</button>
                                        </span>
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="status_rumah" name="status_rumah" class="form-select">
                                        ...
                                        <option value="kontrak bulanan"
                                            {{ $nasabah->alamatLuar->status_rumah == 'kontrak bulanan' ? 'selected' : '' }}>
                                            Kontrak Bulanan</option>
                                        <option value="kontrak tahunan"
                                            {{ $nasabah->alamatLuar->status_rumah == 'kontrak tahunan' ? 'selected' : '' }}>
                                            Kontrak Tahunan</option>
                                        <option value="milik orang tua"
                                            {{ $nasabah->alamatLuar->status_rumah == 'milik orang tua' ? 'selected' : '' }}>
                                            Milik Orang Tua</option>
                                        <option value="pribadi"
                                            {{ $nasabah->alamatLuar->status_rumah == 'pribadi' ? 'selected' : '' }}>Milik
                                            Pribadi</option>
                                    </select>
                                </div>
                                <div class="form-group" id="kontrak-bulanan-group" style="display: none;">
                                    ...
                                    <input type="number" id="biaya_perbulan" name="biaya_perbulan" class="form-control"
                                        value="{{ $nasabah->alamatLuar->biaya_perbulan }}">
                                </div>
                                <div class="form-group" id="kontrak-tahunan-group" style="display: none;">
                                    ...
                                    <input type="number" id="biaya_pertahun" name="biaya_pertahun" class="form-control"
                                        value="{{ $nasabah->alamatLuar->biaya_pertahun }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select id="domisili" name="domisili" class="form-select">
                                        ...
                                        <option value="sesuai ktp"
                                            {{ $nasabah->alamatLuar->domisili == 'sesuai ktp' ? 'selected' : '' }}>Sesuai
                                            KTP
                                        </option>
                                        <option value="tidak sesuai ktp"
                                            {{ $nasabah->alamatLuar->domisili == 'tidak sesuai ktp' ? 'selected' : '' }}>
                                            Tidak
                                            Sesuai KTP</option>
                                    </select>
                                </div>
                                <div class="form-group" id="alamat-lengkap-group" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_domisili" id="alamat_domisili" cols="30" rows="10" class="form-control">{{ $nasabah->alamatLuar->alamat_domisili }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select id="rumah_domisili" name="rumah_domisili" class="form-select">
                                            <option value="">Pilih</option>
                                            <option value="kontrak bulanan"
                                                {{ $nasabah->alamatLuar->rumah_domisili == 'kontrak bulanan' ? 'selected' : '' }}>
                                                Kontrak Bulanan</option>
                                            <option value="kontrak tahunan"
                                                {{ $nasabah->alamatLuar->rumah_domisili == 'kontrak tahunan' ? 'selected' : '' }}>
                                                Kontrak Tahunan</option>
                                            <option value="milik orang tua"
                                                {{ $nasabah->alamatLuar->rumah_domisili == 'milik orang tua' ? 'selected' : '' }}>
                                                Milik Orang Tua</option>
                                            <option value="pribadi"
                                                {{ $nasabah->alamatLuar->rumah_domisili == 'pribadi' ? 'selected' : '' }}>
                                                Milik
                                                Pribadi</option>
                                        </select>
                                    </div>
                                    <div class="form-group" id="domisili-bulanan-group" style="display: none;">
                                        ...
                                        <input type="number" id="biaya_perbulan_domisili" name="biaya_perbulan_domisili"
                                            class="form-control"
                                            value="{{ $nasabah->alamatLuar->biaya_perbulan_domisili }}">
                                    </div>
                                    <div class="form-group" id="domisili-tahunan-group" style="display: none;">
                                        ...
                                        <input type="number" id="biaya_pertahun_domisili" name="biaya_pertahun_domisili"
                                            class="form-control"
                                            value="{{ $nasabah->alamatLuar->biaya_pertahun_domisili }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="lama_tinggal" name="lama_tinggal" class="form-control"
                                        value="{{ $nasabah->alamatLuar->lama_tinggal }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="share_loc_link" name="share_loc_link" class="form-control"
                                        value="{{ $nasabah->alamatLuar->share_loc_link }}">
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="atas_nama_listrik"
                                            id="atas_nama_listrik" value="{{ $nasabah->alamatLuar->atas_nama_listrik }}">
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="hubungan_rek_listrik"
                                            id="hubungan_rek_listrik" value="{{ $nasabah->alamatLuar->hubungan }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="foto_meteran_listrik">Foto Meteran Listrik Rumah</label>
                                    <br>
                                    @if ($nasabah->alamatLuar->foto_meteran_listrik)
                                        <a href="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->alamatLuar->foto_meteran_listrik) }}"
                                            target="_blank">
                                            <img src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->alamatLuar->foto_meteran_listrik) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            ...
                                            value="{{ $nasabah->alamatLuar->foto_meteran_listrik }}">
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn btn-gradient-info py-3"
                                                type="button">Pilih File</button>
                                        </span>
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="perusahaan" id="perusahaan"
                                        value="{{ $nasabah->pekerjaanLuar->perusahaan }}">
                                </div>
                                <div class="form-group">
                                    <label for="alamat_perusahaan" class="form-label">Alamat Perusahaan</label>
                                    <textarea name="alamat_perusahaan" id="alamat_perusahaan" cols="30" rows="10" class="form-control">{{ $nasabah->pekerjaanLuar->alamat_perusahaan }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="status_karyawan" name="status_karyawan" class="form-select">
                                        <option value="">Pilih</option>
                                        <option value="tetap"
                                            {{ $nasabah->pekerjaanLuar->status_karyawan == 'tetap' ? 'selected' : '' }}>
                                            Tetap
                                        </option>
                                        <option value="kontrak"
                                            {{ $nasabah->pekerjaanLuar->status_karyawan == 'kontrak' ? 'selected' : '' }}>
                                            Kontrak</option>
                                    </select>
                                </div>
                                <div class="form-group" id="div-kontrak" style="display: none;">
                                    ...
                                    <input type="text" name="lama_kontrak" id="lama_kontrak" class="form-control"
                                        value="{{ $nasabah->pekerjaanLuar->lama_kontrak }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pendapatan_perbulan" id="pendapatan_perbulan"
                                        class="form-control" value="{{ $nasabah->pekerjaanLuar->pendapatan_perbulan }}">
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        <label for="foto_id_card" class="form-label">Foto ID Card/SKU</label>
                                        <br>
                                        <a href="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->pekerjaanLuar->id_card) }}"
                                            target="_blank">
                                            <img src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->pekerjaanLuar->id_card) }}"alt="Foto KTP"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <br>
                                        @if ($nasabah && $nasabah->pekerjaanLuar && $nasabah->pekerjaanLuar->norek)
                                            <a href="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->pekerjaanLuar->norek) }}"
                                                target="_blank">
                                                <img src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->pekerjaanLuar->norek) }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <br>
                                        @if ($nasabah && $nasabah->pekerjaanLuar)
                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                            ...
                                            <div class="modal fade" id="modalSlipGaji" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <embed
                                                                src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->pekerjaanLuar->slip_gaji) }}"
                                                                type="application/pdf" width="100%" height="500px">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                            ...
                                            <br>
                                            <span class="form-text">File :
                                                {{ $nasabah->pekerjaanLuar->slip_gaji ?? '' }}</span>
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Upload Foto KTP" value="{{ $nasabah->pekerjaanLuar->id_card }}">
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn btn-gradient-info py-3"
                                                type="button">Pilih File</button>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Upload Foto KTP" value="{{ $nasabah->pekerjaanLuar->norek }}">
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn btn-gradient-info py-3"
                                                type="button">Pilih File</button>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Upload Foto KTP"
                                            value="{{ $nasabah->pekerjaanLuar->slip_gaji }}">
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn btn-gradient-info py-3"
                                                type="button">Pilih File</button>
                                        </span>
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="hubungan_penjamin" name="hubungan_penjamin" class="form-select">
                                        ...
                                        <option value="orang tua"
                                            {{ $nasabah->penjaminLuar->hubungan_penjamin == 'Orang Tua' ? 'selected' : '' }}>
                                            Orang Tua</option>
                                        <option value="suami"
                                            {{ $nasabah->penjaminLuar->hubungan_penjamin == 'Suami' ? 'selected' : '' }}>
                                            Suami
                                        </option>
                                        <option value="istri"
                                            {{ $nasabah->penjaminLuar->hubungan_penjamin == 'Istri' ? 'selected' : '' }}>
                                            Istri
                                        </option>
                                        <option value="anak"
                                            {{ $nasabah->penjaminLuar->hubungan_penjamin == 'Anak' ? 'selected' : '' }}>
                                            Anak
                                        </option>
                                        <option value="keluarga kandung"
                                            {{ $nasabah->penjaminLuar->hubungan_penjamin == 'Keluarga Kandung' ? 'selected' : '' }}>
                                            Keluarga Kandung</option>
                                        <option value="lainnya"
                                            {{ $nasabah->penjaminLuar->hubungan_penjamin == 'Lainnya' ? 'selected' : '' }}>
                                            Lainnya</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_penjamin" name="nama_penjamin" class="form-control"
                                        value="{{ $nasabah->penjaminLuar->nama_penjamin }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pekerjaan_penjamin" name="pekerjaan_penjamin"
                                        class="form-control" value="{{ $nasabah->penjaminLuar->pekerjaan_penjamin }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" id="penghasilan_penjamin" name="penghasilan_penjamin"
                                        class="form-control" value="{{ $nasabah->penjaminLuar->penghasilan_penjamin }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="no_hp_penjamin" name="no_hp_penjamin" class="form-control"
                                        value="{{ $nasabah->penjaminLuar->no_hp_penjamin }}">
                                </div>
                                <div class="form-group">
                                    <label for="foto_ktp_penjamin" class="form-label">KTP Penjamin</label>
                                    <br>
                                    <a href="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->penjaminLuar->foto_ktp_penjamin) }}"
                                        target="_blank">
                                        <img src="{{ asset('storage/dokumen_pendukung_luar/' . $folderNasabah . '/' . $nasabah->penjaminLuar->foto_ktp_penjamin) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Upload Foto KTP"
                                            value="{{ $nasabah->penjaminLuar->foto_ktp_penjamin }}">
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn btn-gradient-info py-3"
                                                type="button">Pilih File</button>
                                        </span>
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="kondisi_tanggungan" id="kondisi_tanggungan" cols="30" rows="10" class="form-control">{{ $nasabah->tanggunganLuar->kondisi_tanggungan }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cicilan_lain" id="cicilan_lain" class="form-select">
                                        <option value="">Pilih</option>
                                        <option value="Ada"
                                            {{ optional($nasabah->pinjamanLainLuar->first())->cicilan_lain == 'Ada' ? 'selected' : '' }}>
                                            Ada
                                        </option>
                                        <option value="Tidak"
                                            {{ optional($nasabah->pinjamanLainLuar->first())->cicilan_lain == 'Tidak' ? 'selected' : '' }}>
                                            Tidak
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div id="cicilan-container" style="display: none;">
                                    ...
                                    <div id="dynamic-form-container">
                                        @foreach ($nasabah->pinjamanLainLuar as $index => $cicilan)
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_kontak_darurat" id="nama_kontak_darurat"
                                        class="form-control" value="{{ $nasabah->kontakDarurat->nama_kontak_darurat }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="hubungan_kontak_darurat" id="hubungan_kontak_darurat"
                                        class="form-control"
                                        value="{{ $nasabah->kontakDarurat->hubungan_kontak_darurat }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_hp_kontak_darurat" id="no_hp_kontak_darurat"
                                        class="form-control"
                                        value="{{ $nasabah->kontakDarurat->no_hp_kontak_darurat }}">
                                </div>
                            ...
                            <div class="form-step">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="catatan_marketing" id="catatan_marketing" cols="30" rows="10" class="form-control"></textarea>
                                </div>

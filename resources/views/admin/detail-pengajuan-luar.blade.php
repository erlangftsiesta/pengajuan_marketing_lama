                    ...
                    <div class="card-body">
                                ...
                                <div class="form-check">
                                    <label for="survey_yes" class="form-check-label">
                                        <input type="radio" id="survey_yes" name="is_survey" value="1"
                                            class="form-check-input" {{ $isSurvey ? 'checked' : '' }} disabled>
                                        Ya
                                    </label>
                                </div>
                                <div class="form-check">
                        ...
                        <div class="form-step">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="analisa" id="analisa" class="form-control" cols="30" rows="10" readonly>{{ $approvalCA->analisa ?? 'Belum ada' }}</textarea>
                            </div>
                            ...
                            <div id="approve-section" style="display: none;">
                                <div class="form-group mb-3">
                                    <label for="nominal_pinjaman" class="form-label">Nominal Pinjaman</label>
                                    <input type="text" id="nominal_pinjaman" name="nominal_pinjaman"
                                        class="form-control"
                                        value="Rp. {{ number_format($pengajuan->nominal_pinjaman, 0, ',', '.') }}"
                                        readonly>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="tenor" class="form-label">Jangka Waktu</label>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="catatan_approve" id="catatan_approve" class="form-control" cols="30" rows="10" readonly>{{ $approvalCA->catatan ?? 'Tidak ada catatan' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div id="reject-section" style="display: none;">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="catatan_reject" id="catatan_reject" class="form-control" cols="30" rows="10" readonly>{{ $approvalCA->catatan ?? 'Tidak ada catatan' }}</textarea>
                                </div>
                            </div>
                            ...
                            <!-- Input Nasabah Info -->
                            <h5>Informasi Approval Head Marketing</h5>

                            <!-- Input Catatan -->
                            <div class="form-group mb-3">
                                <label for="status">Status : <span
                                        class="badge {{ optional($approvalHM)->status == 'rejected' ? 'bg-danger' : 'bg-success' }}">
                                        {{ optional($approvalHM)->status ? Str::title($approvalHM->status) : 'Belum ada' }}
                                    </span></label>
                                <br>
                            ...
                            @if ($pengajuan->is_banding == 1)
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="alasan_banding" id="alasan_banding" class="form-control" cols="30" rows="10" readonly>{{ $pengajuan->alasan_banding }}</textarea>
                                </div>
                                ...
                                @php
                                    $approvalBandingCA = $pengajuan->approval
                                        ...
                                        ->first();
                                    $approvalBandingHM = $pengajuan->approval
                                        ->where('role', 'hm')
                                        ->where('is_banding', true)
                                        ->first();
                                @endphp
                                ...
                                <div class="form-group mb-3">
                                    <label for="catatan_bandingca">Catatan Banding Credit Analyst</label>
                                    <br>
                                ...
                                <div class="form-group mb-3">
                                    <label for="catatan_bandinghm">Catatan Banding Head Marketing</label>
                                    <br>
                                    @if ($approvalBandingHM)
                                        <label for="status">Status : <span
                                                class="badge {{ $approvalBandingHM->status == 'rejected' ? 'bg-danger' : 'bg-success' }}">
                                                {{ Str::title($approvalBandingHM->status) }} </span></label>
                                        <textarea name="catatan_bandinghm" id="catatan_bandinghm" class="form-control" cols="30" rows="10"
                                            readonly>{{ $approvalBandingHM->catatan }}</textarea>
                                    @else
                                        <label for="status">
                                            Status: <span class="badge bg-secondary">Belum Ada</span>
                                        </label>

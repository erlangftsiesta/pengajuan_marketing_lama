(function ($) {
  ...
  if ($("#traffic-chart").length) {
    ...
    var gradientStrokeYellow = graphGradient1.createLinearGradient(0, 0, 0, 181);
    gradientStrokeYellow.addColorStop(0, 'rgba(255, 221, 51, 1)');  // Warna kuning terang
    gradientStrokeYellow.addColorStop(1, 'rgba(255, 193, 7, 1)');   // Warna kuning gelap
    var gradientLegendYellow = 'rgba(255, 221, 51, 1)';
    ...
    new Chart(ctx, {
      type: 'doughnut',
      data: {
        labels: [`Proses: ${totalPending} Pengajuan`, `Approved: ${totalApproved} Pengajuan`, `Rejected: ${totalRejected} Pengajuan`],
        datasets: [{
          data: [totalPending, totalApproved, totalRejected],
          backgroundColor: [gradientStrokeYellow, gradientStrokeGreen, gradientStrokeRed],
